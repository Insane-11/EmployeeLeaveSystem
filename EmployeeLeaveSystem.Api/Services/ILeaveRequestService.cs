...
{
    Task<LeaveRequestResponse?> CreateLeaveRequestAsync(CreateLeaveRequest request, int employeeId);
    ...
    Task<bool> UpdateLeaveRequestAsync(int id, UpdateLeaveRequest request, int employeeId);
