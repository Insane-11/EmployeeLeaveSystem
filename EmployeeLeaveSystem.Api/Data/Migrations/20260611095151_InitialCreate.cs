        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalDays = table.Column<decimal>(type: "decimal(4,1)", nullable: false),
                    UsedDays = table.Column<decimal>(type: "decimal(4,1)", nullable: false),
                    RemainingDays = table.Column<decimal>(type: "decimal(4,1)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DurationDays = table.Column<decimal>(type: "decimal(4,1)", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, "Team manager who can review requests", "Manager" },
                    { 3, "Regular employee who can submit requests", "Employee" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LeaveRequestStatuses_Name",
                table: "LeaveRequestStatuses",
                column: "Name",
                unique: true);
